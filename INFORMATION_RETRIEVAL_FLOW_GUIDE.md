...
**File**: [utils/ai_router/ai_router_api.py](utils/ai_router/ai_router_api.py)
...
**File**: [utils/ai_router/ai_router_api.py](utils/ai_router/ai_router_api.py:195)
...
### AI Router Core
- **[utils/ai_router/ai_router_api.py](utils/ai_router/ai_router_api.py)**: FastAPI server, persistent router
